...
``In1" and ``In2" are the names of the inport blocks; ``Inport" is the type of block ``In1"; and the handle is ``77.0003662109375", which is the unique identifier for ``In1". 
